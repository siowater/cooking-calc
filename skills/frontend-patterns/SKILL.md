...
## name: frontend-patterns description: React、Next.js、状態管理、パフォーマンス最適化、およびUIベストプラクティスのためのフロントエンド開発パターン。

# フロントエンド開発パターン (Frontend Development Patterns)

React、Next.js、および高性能なユーザーインターフェースのための、モダンなフロントエンドパターン。
...
// ✅ useCallback: 子コンポーネントに渡す関数用
const handleSearch = useCallback((query: string) => {
  setSearchQuery(query)
}, [])

// ✅ React.memo: 純粋なコンポーネント用
...
**注意**: モダンなフロントエンドパターンは、保守可能で高性能なユーザーインターフェースを可能にします。プロジェクトの複雑さに合ったパターンを選択してください。